...
class GpdPickPlace(object):
    ...
    def generate_grasp_msgs(self, selected_grasps):
            ...
            for i in range(0, len(selected_grasps)):
                ...
                if (angle >= 0):
                    ...
                    continue
                tf_listener_.waitForTransform('/camera_optical_frame', '/ground_link',
		...
		translated_pose = tf_listener_.transformPose("base_link", gp)
                ...
                g.pre_grasp_approach.direction.header.frame_id = "gripper_servo_link"
		...
		translated_pose = tf_listener_.transformPose("base_link", gp_cartesian)
    ...
    def add_object_mesh(self):
        ...
        translated_pose = tf_listener_.transformPose("base_link", obj_pose)
    ...
    def set_pose_constraints(self,tol_joint1,tol_joint2,tol_joint3):
        ...
        joint_constraint.joint_name = "hand_tool_joint"
        ...
        joint_constraint2.joint_name = "joint_6"
        ...
        joint_constraint3.joint_name = "joint_1"
    ...
    def start_con_setup(self):
        self.joints_subscriber = rospy.Subscriber('/joint_states', JointState, self.joints_callback)
    ...
    def joints_callback(self, data):
        if (self.con_joints_indexes == None):
            names = data.name
            j1_index = names.index("joint_1")
            j2_index = names.index("joint_6")
            j3_index = names.index("hand_tool_joint")
    ...
    def wait_for_pcl_and_save(self):
        ...
        self.obj_pc_subscriber = rospy.Subscriber("/camera/depth/points", sensor_msgs.msg.PointCloud2,
                                                  self.obj_pointcloud_callback_pcd)
    ...
    def wait_for_mesh_and_save(self):
      ...
      self.obj_pc_subscriber = rospy.Subscriber("/camera/depth/points", sensor_msgs.msg.PointCloud2 , self.obj_pointcloud_callback)
